...
The measurement of the inclusive $t\bar{t}$ production cross-sections performed in the \emph{l+jets} final state by the ATLAS Collaboration \cite{Aad_2020} and in the \emph{dileptonic} final state by the CMS Collaboration \cite{CMS_inclusive} make use of Profile Likelihood Fit.
...
\end{equation}
where the acceptance $A_{fid}$ is defined as the ratio of $t\bar{t}$ events passing the fiducial region cuts.
The extraction of the fiducial cross-section from data implies a Profile Likelihood Fit \cite{kCranmer}. 
...
\bibitem{kCranmer}
Kyle Cranmer, Practical Statistics for the, 2015
